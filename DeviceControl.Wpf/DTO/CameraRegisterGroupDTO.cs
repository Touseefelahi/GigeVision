...
namespace DeviceControl.Wpf.DTO
{
    public class CameraRegisterGroupDTO
    {
        ...
        public CameraRegisterGroupDTO(string name, ObservableCollection<CameraRegisterGroupDTO> child, CameraRegister cameraRegister = null, List<CameraRegisterDTO> cameraRegisters = null)
        {
            Name = name;
            Child = child;
